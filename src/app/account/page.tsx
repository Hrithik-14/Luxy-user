...
export default function AccountPage() {
  return (
    <InfoPage title="WhatsApp Support">
      <p>
        Need help with your order? We are available on WhatsApp for quick and easy support.
        Whether you have a question about a product, need to track your delivery, or want to
        place a custom order, just send us a message.
      </p>
      <p>
